...
class PostingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create posting" do
    assert_difference('Posting.count') do
      post postings_url, params: { posting: { content: @posting.content, image_url: @posting.image_url, title: @posting.title } }
    end
  ...
  test "should update posting" do
    patch posting_url(@posting), params: { posting: { content: @posting.content, image_url: @posting.image_url, title: @posting.title } }
